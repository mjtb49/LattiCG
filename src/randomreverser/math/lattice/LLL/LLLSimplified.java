...
public class LLLSimplified {
    ...
    public LLLSimplified(BigMatrix lattice,Params params) {
    ...
    public static Result reduce(BigMatrix lattice, Params params) {
        return new LLLSimplified(lattice,params).reduceLLL(lattice);
    }
    public static Result reduce(BigMatrix lattice) {
        return new LLLSimplified(lattice,new Params()).reduceLLL(lattice);
    }
